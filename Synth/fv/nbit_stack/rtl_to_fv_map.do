...
# Generated on: Mon Dec 02 15:51:32 EST 2024 (Mon Dec 02 20:51:32 UTC 2024)
...
set logfile fv/nbit_stack/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/nbit_stack -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/opt/eda/cadence/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/opt/eda/cadence/GENUS211/tools.lnx86"
set env(CW_DIR) "/opt/eda/cadence/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/opt/eda/cadence/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /opt/eda/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/opt/eda/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/opt/eda/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/opt/eda/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/opt/eda/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /opt/eda/cadence/local/GSCLIB045_Fall2024_SymbolwithVDDVSS/lan/flow/t1u1/reference_libs/GPDK045/gsclib045_all_v4.4/gsclib045/timing -library -both
read_library -liberty -both \
    /opt/eda/cadence/local/GSCLIB045_Fall2024_SymbolwithVDDVSS/lan/flow/t1u1/reference_libs/GPDK045/gsclib045_all_v4.4/gsclib045/timing/slow_vdd1v2_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/shivansa/CUSTOM-CIRCUIT-DESIGN/PROJECT_shivansa/Synth/InputFiles/RTL/verilog.v
elaborate_design -golden -root {nbit_stack} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/nbit_stack/fv_map.v.gz
elaborate_design -revised -root {nbit_stack}
...
#add_name_alias fv/nbit_stack/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.nbit_stack.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.nbit_stack.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.nbit_stack.rtl.fv_map.rpt
