...
create_analysis_view -name nbit_stack_view_setup -constraint_mode common -delay_corner nbit_stack_delayCorner -latency_file ${::IMEX::dataVar}/mmmc/views/nbit_stack_view_setup/latency.sdc
create_analysis_view -name nbit_stack_view_hold -constraint_mode common -delay_corner nbit_stack_delayCorner -latency_file ${::IMEX::dataVar}/mmmc/views/nbit_stack_view_hold/latency.sdc
